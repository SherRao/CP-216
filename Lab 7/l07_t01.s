...
-------------------------------------------------------
*/
STMFD  SP!, {LR}        // Added both lines so that the PC stores the proper value to return to.
BL     isLowerCase      // test for lowercase
CMP    R0, #0
BLEQ   isUpperCase      // not lowercase? Test for uppercase.
LDMFD  SP!, {PC}        // Added both lines so that the PC stores the proper value to return to.
